...
TARGETS = (
    ...
    ROOT / "tools/handoff_watcher.py",
    ROOT / "tools/handoff_watcher_v2.py",
    ROOT / "config/m5-0-allowlist.yaml",
    ROOT / "config/souls/reviewer/SOUL.md",
    ROOT / "config/souls/fixer/SOUL.md",
    ROOT / "config/souls/verifier/SOUL.md",
    ROOT / "tests/m4f1",
    ROOT / "tests/m5_0/test_m5_strict_parser.py",
    ROOT / "tests/m5_0/test_m5_handoff_logic.py",
    ROOT / "tests/m5_0/m5_0b_delivery_digest.py",
    ROOT / "tests/m5_0/test_m5_0b_delivery_digest.py",
    ROOT / "tests/m5_0/m5_0b_delivery_required.txt",
    ROOT / "tests/m5_0/fixtures/inject_skill_completion.py",
    ROOT / "tests/m5_0/fixtures/run_m5_concurrency.py",
    ROOT / "tests/m5_0/_m5_0b_integration_inner.sh",
    ROOT / "tests/m5_0/run_m5_0b_integration.sh",
    ROOT / "tests/m5_0/_concurrency_inner.sh",
    ROOT / "tests/m5_0/run_m5_0b_concurrency.sh",
