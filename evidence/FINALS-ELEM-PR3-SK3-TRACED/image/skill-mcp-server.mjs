...
function runSkill(module, inputObj) {
  const code = `
import sys, json
...
const TOOLS = [
  ...
  },
  {
    ...
    description: 'DETERMINISTIC skill: retrieve similar historical cases for a change context.',
    inputSchema: {
      type: 'object',
      properties: { change_context: { type: 'object' }, top_k: { type: 'number' } },
      required: ['change_context'],
    },
  },
];
