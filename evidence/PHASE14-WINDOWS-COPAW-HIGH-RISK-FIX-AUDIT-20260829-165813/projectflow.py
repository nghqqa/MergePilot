    ...
    for current_project_id in project_ids:
        ...
        for task in tasks:
            ...
            base = {
                ...
                "assignedTo": task.assigned_to,
                "planStatus": task.status,
                "taskPath": store.task_shared_path(meta.project_id, task.task_id),
            }

            try:
                task_meta = store.read_task_meta(
                    task.task_id, project_id=meta.project_id,
                )
            ...
            try:
                ...
                task_dir = store._task_dir(task.task_id, meta.project_id)
