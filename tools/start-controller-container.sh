...
# M5-0 Candidate env vars (all default to production-compatible values)
M4F_LIVE_MODE="${M4F_LIVE_MODE:-0}"
M4F_ONLY_MODE="${M4F_ONLY_MODE:-0}"
MATRIX_USER="${MATRIX_USER:-admin}"
CONTROLLER_CONSUMER_NAME="${CONTROLLER_CONSUMER_NAME:-controller}"
M4F_ALLOWED_ROOMS="${M4F_ALLOWED_ROOMS:-}"
M4F_ALLOWED_SENDERS="${M4F_ALLOWED_SENDERS:-}"
M4F_RUN_PREFIX="${M4F_RUN_PREFIX:-}"
