...
| B2 最小权限矩阵 | ✅ closed `m3b-b2-closed` | policy.yaml deny-by-default(44 工具:reviewer 26 / fixer 40 / coordinator 44 可见)+ fixer 写操作 arg 校验(repo/base allowlist、fix/ 前缀、路径 denylist、受保护分支)+ L2 占位拒绝 |
